                                                ...
                                                <table class="table table-hover">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="dash-list-text recent-ac-text">15</td>
                                                            <td class="dash-list-text recent-ac-text">60000</td>
                                                        </tr>
                                                        
                                                        <tr>
                                                            <td class="dash-list-text recent-ac-text">EXECUTIVE</td>
                                                            <td class="dash-list-text recent-ac-text">25</td>
                                                            <td class="dash-list-text recent-ac-text">107000</td>
                                                        </tr>

                                                        <tr>
                                                            <td class="dash-list-text recent-ac-text">TOTAL</td>
                                                            <td class="dash-list-text recent-ac-text">50</td>
                                                            <td class="dash-list-text recent-ac-text">202000</td>
                                                        </tr>
